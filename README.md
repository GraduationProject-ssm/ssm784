...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=179)


# 第1章 绪论
## 1.1 研究背景
互联网概念的产生到如今的蓬勃发展，用了短短的几十年时间就风靡全球，使得全球各个行业都进行了互联网的改造升级，标志着互联网浪潮的来临。在这个新的时代，各行各业都充分考虑互联网是否能与本行业进行结合，是否能解决本行业或者本行业中某些方面的自古以来的痛点。长期以来，数据内容，数据传播，数据储存等都是一门门专业的内容，因为需要记住的内容很多，造成古人的言简意赅，如今互联网的到来让数据更加的清晰好认不复杂，一目了然不出错，毕竟在整个历史上数据的丢失，传承的断代，都是因为数据不能好好的保存，不能好好的流传。当年的年代用互联网思维和互联网技术，对大量数据的录入更新，存储汇总，备份分析方面，使得远远的超过传统的数据管理技术。在这样的时代潮流下，采用新技术开发新软件，对传统行业进行革命性的改造成为了当今的主流。本次开发穿戴搭配系统，解决了穿搭信息管理关于数据方面的管理分析，存储传输的痛点，不仅仅对管理员提供了便利，还能提高用户的满意度。
## 1.2目的和意义
此次穿戴搭配系统的开发，需要用到的知识不仅涉及到界面设计与功能设计方面的知识，还需要涉及到数据库与编程语言上面的知识，这些知识点对于一个即将毕业的学生来说，一是为了巩固在校所学相关专业知识；二是为了让学生学会如何将专业理论知识运用于现实软件的开发过程；三是让学生明白知识是无穷无尽的，要时刻明白活到老学到老的真正含义，让学生要养成时刻学习的习惯，同时也要相信通过此次程序的开发，会让学生对于专业知识的理解与软件开发水平的提高有着极大的帮助。
## 1.3 论文研究内容
...
![C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭.jpg")
图4.1 穿搭实体属性图

（2）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\用户.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\用户.jpg")
图4.2 用户实体属性图

（3）下图是穿搭讲堂收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭讲堂收藏.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭讲堂收藏.jpg")
图4.3 穿搭讲堂收藏实体属性图

（4）下图是穿搭讲堂实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭讲堂.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭讲堂.jpg")
图4.4 穿搭讲堂实体属性图

（5）下图是购物车实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\购物车.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\购物车.jpg")
图4.5 购物车实体属性图

（6）下图是穿搭讲堂留言实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭讲堂留言.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭讲堂留言.jpg")
图4.6 穿搭讲堂留言实体属性图

（7）下图是论坛实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\论坛.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\论坛.jpg")
图4.7 论坛实体属性图

（8）下图是穿搭收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭收藏.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭收藏.jpg")
图4.8 穿搭收藏实体属性图

（9）下图是穿搭评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭评价.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭评价.jpg")
图4.9 穿搭评价实体属性图

（10）下图是穿搭订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭订单.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\穿搭订单.jpg")
图4.10 穿搭订单实体属性图

（11）下图是收货地址实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\chuandaidapei\收货地址.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\chuandaidapei\收货地址.jpg")
图4.11 收货地址实体属性图


### 4.4.2 数据库表结构
在进行这部分设计之前，需要明白和掌握数据类型以及各个数据类型的长度范围等知识，因为在一张具体的数据表中，为了方便理解，这里就举个简单的例子。比如用户信息表，这个表格的字段就是用户这个实体具备的属性，这时就需要对字段进行数据类型，以及字段长度的设置，也要设置一个主键来作为用户信息表的唯一标识。这些都是数据库表结构设计需要完成的内容。根据穿戴搭配系统的功能设计以及数据库设计要求，展示该系统的数据表结构。
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|chuanda\_name|String|穿搭名称|是|
|3|chuanda\_photo|String|照片|是|
|4|chuanda\_types|Integer|穿搭类型|是|
|5|fengge\_types|Integer|风格|是|
|6|changhe\_types|Integer|场合|是|
|7|shencai\_types|Integer|身材|是|
|8|chuanda\_kucun\_number|Integer|穿搭库存|是|
|9|chuanda\_price|Integer|购买获得积分|是|
|10|chuanda\_old\_money|BigDecimal|穿搭原价|是|
|11|chuanda\_new\_money|BigDecimal|现价/积分|是|
|12|chuanda\_clicknum|Integer|点击次数|是|
|13|shangxia\_types|Integer|是否上架|是|
|14|chuanda\_delete|Integer|逻辑删除|是|
|15|chuanda\_content|String|穿搭简介|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|chuanda\_id|Integer|穿搭|是|
|3|yonghu\_id|Integer|用户|是|
|4|chuanda\_collection\_types|Integer|类型|是|
...
|2|chuanda\_id|Integer|穿搭|是|
|3|yonghu\_id|Integer|用户|是|
|4|chuanda\_commentback\_text|String|评价内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|chuanda\_order\_uuid\_number|String|订单号|是|
|3|address\_id|Integer|收获地址|是|
|4|chuanda\_id|Integer|穿搭|是|
|5|yonghu\_id|Integer|用户|是|
|6|buy\_number|Integer|购买数量|是|
|7|chuanda\_order\_true\_price|BigDecimal|实付价格|是|
|8|chuanda\_order\_courier\_name|String|快递公司|是|
|9|chuanda\_order\_courier\_number|String|订单快递单号|是|
|10|chuanda\_order\_types|Integer|订单类型|是|
|11|chuanda\_order\_payment\_types|Integer|支付类型|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|chuandajiangtang\_name|String|讲堂名称|是|
|3|chuandajiangtang\_photo|String|讲堂照片|是|
|4|chuandajiangtang\_video|String|讲堂视频|是|
|5|chuandajiangtang\_types|Integer|讲堂类型|是|
|6|chuandajiangtang\_clicknum|Integer|点击次数|是|
|7|shangxia\_types|Integer|是否上架|是|
|8|chuandajiangtang\_delete|Integer|逻辑删除|是|
|9|chuandajiangtang\_content|String|讲堂详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|chuandajiangtang\_id|Integer|穿搭讲堂|是|
|3|yonghu\_id|Integer|用户|是|
|4|chuandajiangtang\_collection\_types|Integer|类型|是|
|5|insert\_time|Date|收藏时间|是|
|6|create\_time|Date|创建时间|是|
表4.9穿搭讲堂留言表
...
|2|chuandajiangtang\_id|Integer|穿搭讲堂|是|
|3|yonghu\_id|Integer|用户|是|
|4|chuandajiangtang\_liuyan\_text|String|留言内容|是|
...
## 5.1管理员功能实现
### 5.1.1 穿搭管理
此页面让管理员管理穿搭的数据，穿搭管理页面见下图。此页面主要实现穿搭的增加、修改、删除、查看的功能。

![](/md/blog.018.png)

图5-1 穿搭管理页面
### 5.1.2 论坛信息管理
论坛信息管理页面提供的功能操作有：新增论坛，修改论坛，删除论坛操作。下图就是论坛信息管理页面。

![](/md/blog.019.png)

图5.3 论坛信息管理页面
### 5.1.3帖子类型管理
帖子类型管理页面显示所有帖子类型，在此页面既可以让管理员添加新的论坛信息类型，也能对已有的帖子类型信息执行编辑更新，失效的帖子类型信息也能让管理员快速删除。下图就是帖子类型管理页面。
